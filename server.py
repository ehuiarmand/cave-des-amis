                ...
                for _key in _GLOBAL_PATCH_KEYS:
                    ...
                    if _key == "casiers":
                        ...
                        if put_delta.get("casiers"):
                            ...
                            # Sauvegarde complète : ne pas persister les tombstones
                            # (lignes marquées _deleted par le client) sinon des casiers
                            # fantômes réapparaissent pour admin/tanoh.
                            current["casiers"] = [
                                r for r in sanitized if not r.get("_deleted")
                            ]
                        ...
                        # ({..., "_deleted": true}) pour éviter que des lignes
                        # supprimées ne soient persistées (et réapparaissent) chez
                        # les superadmins globaux (admin/tanoh).
                        _val = payload[_key]
